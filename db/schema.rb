...
ActiveRecord::Schema.define(:version => 20130920154620) do
  ...
  add_index "faculty_admins", ["faculty_id"], :name => "index_faculty_admins_on_faculty_id"
  add_index "faculty_admins", ["user_id"], :name => "index_faculty_admins_on_user_id"
